...
\begin{frame}{Different types of multilingualism}
After \citep{luepke16} we distinguish between 
\begin{itemize}
\item multilingual interaction governed by any hierarchical relationships
\item small-scale multilingualism scale
\begin{itemize}
\item reciprocal
\item receptive
\item passive
...
\end{itemize}
\pause 
It looks like in Daghestan small-scale multilingualism is governed by language comunity size. So we expect people in minority language communities to be more multilingual than the speaker of larger languages. \pause
We want
\begin{itemize}
\item quantitatively test this hypothesis
\item show a nice example of minority comunity of non minority language
\end{itemize}
\end{frame}
...
\item we grouped all languages into three categories according to the nowaday number of speakers
\begin{itemize}
